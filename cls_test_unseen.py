...
def get_args():
    ...
    parser.add_argument('--test_dict_path', type=str, default='./datasets/split_and_test_dicts/brax_test_dict.npy')
...
def main():
    ...
    test_fpaths=test_dict['test_fpaths']
    test_labels=test_dict['test_labels']
    test_mask_fpaths=test_dict['test_mask_fpaths']
